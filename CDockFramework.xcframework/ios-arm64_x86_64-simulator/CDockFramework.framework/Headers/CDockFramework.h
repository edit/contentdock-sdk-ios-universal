...
//! Project version number for CDockFramework.
FOUNDATION_EXPORT double TEVFrameworkVersionNumber;

//! Project version string for CDockFramework.
FOUNDATION_EXPORT const unsigned char TEVFrameworkVersionString[];
